...
const list_dataSlice = createSlice({
  ...
  reducers: {
    addExpense(state, action) {
      state.totalAmount = state.totalAmount + Number(action.payload.expense.amount);

      const updatedItems = state.Expenses.concat({...action.payload.expense, id:action.payload.id});
